...
const CertificationsPage = () => {
  ...
  const certifications = [
    ...
    },
    {
      ...
      date: '2026',
      description: 'Completed AWS Academy Cloud Foundations with hands-on labs covering core cloud computing concepts, AWS global infrastructure, security (IAM & shared responsibility model), VPC networking, EC2 compute, serverless (Lambda), storage (S3, EBS, EFS, Glacier), databases (RDS, DynamoDB, Aurora, Redshift), cloud architecture using the AWS Well-Architected Framework, and monitoring & scaling with CloudWatch, Load Balancing, and Auto Scaling.',
      skills: ['AWS Cloud', 'AWS Architecture', 'Amazon EC2', 'Amazon S3', 'AWS IAM', 'Amazon VPC', 'AWS Lambda', 'Amazon RDS', 'Amazon DynamoDB', 'CloudWatch', 'Auto Scaling'],
      icon: <Award className="w-12 h-12" style={{ color: `var(--primary-color)` }} />,
      link: 'https://www.credly.com/badges/d78a126e-33a1-4fad-bfe9-52b1370a3d28/public_url',
      featured: true,
    },
    {
    ...
    },
    {
      ...
      issuer: 'Forage - Tata Micro Internship',
      date: '2026',
      description: 'Completed practical tasks in exploratory data analysis, AI-based delinquency prediction, business reporting, and implementing AI-driven collections strategies.',
      skills: ['Generative AI', 'Data Analytics', 'Exploratory Data Analysis', 'AI Strategy'],
      icon: <Trophy className="w-12 h-12" style={{ color: `var(--primary-color)` }} />,
      link: 'https://drive.google.com/file/d/1R0CDnXPMYTUmSps2FO6TUO3s-RcO46-8/view?usp=drive_link',
      featured: true,
    },
    {
      ...
      issuer: 'Forage - Tata Micro Internship',
      date: '2026',
      description: 'Completed practical tasks in framing business scenarios, selecting appropriate visualizations, creating effective visuals, and communicating data insights for business decision-making.',
    ...
    },
    {
      ...
      issuer: 'Forage - Tata Micro Internship',
      date: '2026',
      description: 'Completed practical cybersecurity tasks including Identity and Access Management (IAM) fundamentals, IAM strategy assessment, crafting custom IAM solutions, and platform integration.',
    ...
    },
    {
      ...
      issuer: 'Forage - Tata Micro Internship',
      date: '2026',
      description: 'Completed practical tasks in understanding and analysing client needs, assessing sustainability solutions through comparative analysis, and presenting a fitment matrix to recommend suitable ESG strategies.',
  ...
  const achievements = [
    ...
    }, 
    {
      ...
      description: 'Participated in PCCOE’s international challenge themed "AI for Climate Change", exploring AI-driven solutions for climate issues and global sustainability collaboration.',
      icon: <Award className="w-8 h-8" style={{ color: `var(--primary-color)` }} />,
    },
  ];
